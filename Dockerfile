...
RUN apt-get update && \
    apt-get -y install git-core net-tools python-pip python-netifaces python-simplejson python-imaging python-dev sqlite3 libffi-dev libssl-dev libmagic-dev mplayer && \
    apt-get clean
